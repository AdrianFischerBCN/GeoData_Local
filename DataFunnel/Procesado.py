...
while pto < total_puntos:
    nueva_fila = {
        lst_points[pto]: [lst_points[pto],
                          ...
                          json.dumps((lst_series[pto].pvals).tolist()),
                          json.dumps((lst_series[pto].normals["weights"]).tolist()),
                          json.dumps((lst_series[pto].normals["means"]).tolist()),
                          json.dumps((lst_series[pto].normals["covars"]).tolist())]}
